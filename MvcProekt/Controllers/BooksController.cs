...
namespace MvcProekt.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            return View(await _context.Books.Include(books => books.Author).ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,YearPublished,NumPages,Description,Publisher,FrontPage,DownloadUrl,AuthorId")] Books books)
        {
            if (id != books.Id)
            {
                return NotFound();
